        ...
        return (
            <div className="col-3" key={index}>
                <div className="card1 text-center">
                    <div className="card">
                        <img id="img" className="card-img-top" src={fac.FacultyImage} alt="" />
                        <div className="card-body">
                            <h5 className="card-title">{fac.FacultyName}</h5>
                            <p className="card-text " style={{ color: "red" }}>{fac.FacultyDesignation}</p>
                        </div>
                        <ul className="list-group list-group-flush border-border-primary " >
                            <li className="list-group-item" id="list">{fac.FacultyEducationQualification}</li>
                            <li className="list-group-item " id="list">{fac.FacultyExperience}</li>
                            <li className="list-group-item " id="list">Working with us from - {fac.FacultyWorkingSince}</li>
                        </ul>
                        <div className="card-body">
                            {/* <a href={fac.FacultyImage} className="btn btn-primary">Open Image</a> */}
                            <button className="btn btn-danger" onClick={()=> FacDelete(index)}>Delete</button>
                        </div>
                    </div>
                </div>
            </div>
